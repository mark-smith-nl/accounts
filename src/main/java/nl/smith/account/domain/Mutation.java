...
public class Mutation {
    ...
    public String toString() {
        return "Mutation [accountNumber=" + accountNumber + ", currency=" + currency + ", transactionDate=" + transactionDate + ", balanceBefore="
                + balanceBefore + ", balanceAfter=" + balanceAfter + ", interestDate=" + interestDate + ", amount=" + amount + ", description=" + description
                + "]";
    }
